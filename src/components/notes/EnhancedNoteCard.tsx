...
interface EnhancedNoteCardProps {
  ...
  onRatingUpdate?: (noteId: string, newRating: number, newCount: number) => void;
...
export const EnhancedNoteCard: React.FC<EnhancedNoteCardProps> = ({
  ...
  const [ratingCount, setRatingCount] = useState(note.ratingCount);
  ...
  const handleRatingUpdate = (newRating: number, newCount: number) => {
    ...
    onRatingUpdate?.(note.id, newRating, newCount);
  };
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            {/* Favorite Button */}
            {note.category === 'shared' && onFavorite && (
              <button
        ...
        <div className="flex space-x-2">
          ...
          {note.category === 'shared' && !showReviews && (
            <Button
              variant="outline"
              size="sm"
